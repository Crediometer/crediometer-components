...
const CredioCard = () => {
    return (
        <div>
            <div className="container-fluid pt-5 px-md-5 px-lg-5 mx-auto credio-card-container">
                <div className="row">
                    <div className="mt-3 col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div className="mt-3 mr-6 col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <div className="card credio-card" style={{
                    ...
                    <div className="mt-3 mb-5 col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <div className="card credio-card" style={{
